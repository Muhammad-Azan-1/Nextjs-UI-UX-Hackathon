      ...
      <div className="w-full h-auto mt-24">
        ...
        <div className="w-full h-auto flex mt-16 justify-center gap-x-[28px] gap-y-[50px] min5:gap-5 items-center flex-wrap lg:flex-nowrap px-3 xl:px-0">
          <div className="w-[100%] min4:w-[430px] h-[280px] bg-[#FFF6FB] px-6 py-4  flex flex-col">
            <div className="mt-1">
              <h1 className="font-josefin font-[600] text-[25px] text-[#151875]">
                23% off in all products
              </h1>
              <p className="text-[#FB2E86] inline-block font-[600] font-lato border-b-[1px] border-b-[#FB2E86]">
                Shop Now
              </p>
            </div>
            <div className="flex justify-end ml-4 pb-10 ">
              <Image
                ...
                alt="clock image"
                className="w-[213px] max-w:w-[170px]"
                width={213}
                height={220}
              ></Image>
            </div>
          ...
          <div className="h-[280px] w-[290px] flex flex-col  justify-between items-center  ">
            <div className="flex w-full justify-between items-center">
              ...
              <div>
                ...
                <p className="text-[#151875] text-[12px] font-josefin min5:ml-1 line-through">
                  $32.00
                </p>
              </div>
            </div>
            ...
            <div className="flex w-full justify-between items-center">
              ...
              <div>
                ...
                <p className="text-[#151875] text-[12px] font-josefin ml-1 min5:ml-0 line-through">
                  $32.00
                </p>
              </div>
            </div>
