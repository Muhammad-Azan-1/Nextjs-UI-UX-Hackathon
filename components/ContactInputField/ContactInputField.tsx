...
const CountryFlags: { [key: string]: string } = {
  ...
  "+91":
    "https://cdn.shopify.com/shopifycloud/checkout-web/assets/c1.en/assets/in.5QH_r_CK.svg", // India
  "+86":
...
const ContactInputField = () => {
  ...
  return (
    <>
      <div
        className={`flex w-full justify-between items-center cursor-pointer  h-[50px] 
      ...
      {Error ? (
        <p className="text-[#DD1D1D] text-[15px] mt-1">
          Please enter a valid country code (e.g., +92, +91, +86)
        </p>
      ) : (
        ""
      )}
