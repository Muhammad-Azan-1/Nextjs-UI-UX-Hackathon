...
export const metadata: Metadata = {
  ...
  keywords: 'Sofas, Furniture, E-commerce, Premium Sofas, Home Decor, Comfortable Sofas, Login',
  authors: [
    {
      name: 'Hekhto Team',
  ...
  openGraph: {
    title: 'Login | Hekhto Sofas - Premium Sofas for Your Home',
    description: 'Login to Ihekhto and enjoy a personalized experience to shop for high-quality, comfortable sofas.',
    type: 'website',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Login | Hekhto Sofas - Premium Sofas for Your Home',
    description: 'Login to Ihekhto for a seamless shopping experience and find your perfect sofa.',
  },
  robots: {
    index: true,
    follow: true,
    ...
    <>
      ...
      <div className="w-full mt-24 flex justify-center items-center">
        ...
        <div id="shadow" className="max12:w-[350px] max10:w-[400px] w-[500px] sm:w-[550px] h-[470px] bg-white pt-10 max12:px-4 max10:px-8 px-12 text-[#000000] ">
          ...
          <div className="mt-8">
            <input type="text" placeholder='Email Address' className='border-[1px] border-[#C2C5E1] pl-3 w-[100%]  sm:w-[432px] h-[52px]' aria-label="Email Address" />
            <input type="text" placeholder="Password" className='border-[1px] border-[#C2C5E1] mt-6 pl-3  w-[100%]  sm:w-[432px] h-[52px]' aria-label="password" />
