...
export const metadata: Metadata = {
  ...
  description:
    "Learn about Hekhto, your trusted source for premium sofas. Discover our history, mission, and the wide range of sofas we offer to enhance your home decor.",
  keywords:
    "Sofas, Furniture, Home Decor, Premium Sofas, E-commerce, About Us, Sofa Business, Quality Sofas, Ihekhto",
};
  ...
  return (
    <>
      ...
      <div className="w-full min-h-screen pb-16">
        ...
        <div className="mt-8">
          <ShopeOffer heading="Our Features" />
        </div>

        <div className="bg-[#FBFBFF] h-[503px] w-full mt-[130px]">
          <div className="w-full text-center pt-14">
            <h1 className="text-[35px] md:text-[42px] text-[#151875] font-[700] font-josefin">
              Our Client Say!
            </h1>
          </div>
          ...
          <div className="w-full flex flex-col justify-center items-center mt-6">
            <h1 className="text-[#151875] text-[25px] font-[600] font-lato tracking-wide">
              Selina Gomez
            </h1>
            <h3 className="font-lato font-[600] text-[#8A8FB9] mt-1 text-[12px]">
