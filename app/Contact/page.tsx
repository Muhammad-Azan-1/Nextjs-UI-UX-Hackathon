...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with Hekhto for support, inquiries, or partnerships.",
  keywords: "Contact, Ecommerce, Sofas, Support, Inquiries, Partnerships",
};
const Contact = () => {
  return (
    <>
      ...
      <div className="w-full flex flex-col lg:flex-row h-auto justify-center items-center gap-x-2 min5:gap-x-10 min7:gap-x-16 px-2 pt-[70px] min7:px-0">
        <div className=" w-full lg:w-[550px] text-center lg:text-left">
          <h1 className="text-[30px] min-w2:text-[40px] sm:text-[50px] lg:text-[36px] font-josefin pb-4 lg:pb-0 text-[#151875] font-[600] mb-1">
            Information About us
          </h1>
          <p className=" font-lato  lg:px-0 leading-[25.6px] text-[#8A8FB9]">
        ...
        <div className="w-full lg:w-auto pt-16 lg:pt-0">
          <h1 className="text-[30px] min-w2:text-[40px]  sm:text-[50px] lg:text-[36px] text-center lg:text-left font-josefin text-[#151875] font-[600] mb-3">
            Contact Way
          </h1>
            ...
            <div className="  flex flex-col min-w2:flex-row gap-y-8 min-w2:gap-y-0 justify-center min-w2:justify-start gap-x-16 lg:gap-x-8 min5:gap-x-10">
              <div className="flex">
                ...
                <div className="flex flex-col ml-4">
                  <h2 className="text-[#8A8FB9] text-[14px] min5:text-[16px] hover:underline ">
                    Tel: 877-67-88-99
                  </h2>
                  <p className="text-[#8A8FB9]  text-[14px] min5:text-[16px] hover:underline ">
      ...
      <div className="w-full flex flex-col lg:flex-row items-center lg:items-start justify-center px-2 min7:px-0 pt-20 ">
        <div className="w-full lg:w-[470px] min5:w-[535px] min7:w-[545px] flex flex-col items-center lg:items-end justify-center  gap-y-10 ml-1 min7:ml-12">
          <div className="w-full">
            <h1 className="text-[30px] min-w2:text-[40px] sm:text-[50px] lg:text-[36px] font-josefin text-center lg:text-left text-[#151875] font-[600] ">
              Get In Touch
            </h1>
            <p className="text-[#8A8FB9] text-center lg:text-left mt-2">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mattis
          ...
          <div className="w-full sm:w-[600px] lg:w-[470px]  min5:w-[530px] min7:w-auto flex flex-col gap-y-[35px] ">
            <div className="flex justify-between lg:justify-start ">
              <input
                ...
                className="w-[50%] lg:w-[255px] h-[45px] border-[1px] border-[#A4B6C8B2] pl-3"
              />
              <input
                type="text"
                placeholder="Your E-mail"
                className="ml-8 w-[50%] lg:w-[255px] h-[45px] border-[1px] border-[#A4B6C8B2] pl-3"
              />
            </div>
            ...
            <div>
              <input
                placeholder="Subject*"
                className="w-full h-[45px] border-[1px] border-[#A4B6C8B2] pl-3"
              />
            </div>
            ...
            <div>
              <textarea
                ...
                className="pl-4 pt-3 border-[1px] border-[#A4B6C8B2] w-full"
                rows={8}
              ></textarea>
            </div>
        ...
        <div className=" flex h-auto lg:h-[625px] justify-center items-center pt-8 lg:pt-0 pr-0 lg:pr-3 xl:pr-0">
          <Image
            ...
            alt="contact box"
            className="w-full sm:w-[600px] lg:w-[550px] min7:w-[650px]"
            width={650}
            height={550}
          />
        </div>
