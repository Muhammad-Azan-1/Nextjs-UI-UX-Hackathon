...
export const metadata: Metadata = {
  ...
  description: 'Get in touch with Hekhto for support, inquiries, or partnerships.',
      ...
      <div className="w-full flex flex-col lg:flex-row h-auto justify-center items-center gap-x-2 min5:gap-x-10 min7:gap-x-16 px-2 pt-[70px] min7:px-0">
        <div className=" w-full lg:w-[550px] text-center lg:text-left">
          ...
          <div className="flex pt-8 lg:pt-10 justify-center lg:justify-start">
            <Image src='/images/bluedot.svg' alt='red dot' width={25} height={25} priority></Image>
            <Image src='/images/reddot.svg' className="ml-2" alt='red dot' width={25} height={25} priority></Image>
            <Image src='/images/greendot.svg' alt='red dot' className="ml-2" width={25} height={25} priority></Image>
          </div>
        </div>
          ...
          <div className="flex flex-col justify-center pt-4 lg:pt-0 items-center w-[100%] lg:w-auto lg:items-start gap-y-12">
            <div className="  flex flex-col min-w2:flex-row gap-y-8 min-w2:gap-y-0 justify-center min-w2:justify-start gap-x-16 lg:gap-x-8 min5:gap-x-10">
              <div className="flex">
                ...
                <div className="flex flex-col ml-4">
                  <h2 className="text-[#8A8FB9] text-[14px] min5:text-[16px] hover:underline ">Tel: 877-67-88-99</h2>
              ...
              <div className="flex">
                ...
                <div className="flex flex-col ml-4">
                  <h2 className="text-[#8A8FB9] text-[14px] min5:text-[16px]  hover:underline ">Support Forum</h2>
            ...
            <div className="flex flex-col min-w2:flex-row gap-y-8 min-w2:gap-y-0 justify-center  min-w2:justify-start max10:ml-[-5px]  ml-10 sm:ml-12  lg:ml-0 max10:gap-x-12  gap-x-16 lg:gap-x-8  min5:gap-x-10 ">
              <div className="flex">
                ...
                <div className="flex flex-col ml-4">
                  <h2 className="text-[#8A8FB9] text-[14px] min5:text-[16px] hover:underline ">20 Margaret st, London</h2>
              ...
              <div className="flex">
                ...
                <div className="flex flex-col ml-4">
                  <h2 className="text-[#8A8FB9] text-[14px] min5:text-[16px] hover:underline ">Free standard shipping</h2>
